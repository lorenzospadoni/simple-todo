class TodoItem extends HTMLElement {
    ...
    constructor() {
        super();
        this.instance_style = new CSSStyleSheet(); 
    ...
    adoptStylesheet() {
        this.instance_style.replaceSync(`
        input, span {
        display: inline-block;
        }
        `);
        this.root.adoptedStyleSheets = [this.instance_style]
    }

    addMutationObservers() {
        // I found this in the HTML specifications on 
        //  whatwg.org, I don't really know what that site is
        // but it was linked on MDN so they must be some big shots
